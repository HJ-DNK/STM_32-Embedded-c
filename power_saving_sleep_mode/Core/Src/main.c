...
int main(void)
{
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
		...
		HAL_GPIO_WritePin(BSP_LED1_GPIO_Port, BSP_LED1_Pin, SET); // reset
		HAL_Delay(5000);
		...
		HAL_GPIO_WritePin(BSP_LED1_GPIO_Port, BSP_LED1_Pin, RESET); // Just to indicate that the sleep mode is activated
