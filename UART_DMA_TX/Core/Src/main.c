...
void HAL_UART_RxHalfCpltCallback(UART_HandleTypeDef *huart) {
	...
	HAL_GPIO_WritePin(BSP_LED2_GPIO_Port, BSP_LED2_Pin, SET);

}

void HAL_UART_RxCpltCallback(UART_HandleTypeDef *huart) {
	HAL_UART_Receive_DMA(&huart2, rx_data, 10);
	HAL_GPIO_WritePin(BSP_LED2_GPIO_Port, BSP_LED2_Pin, RESET);
...
int main(void) {
	...
	// HAL_UART_Transmit_DMA(&huart2, data, 12);
//	  HAL_Delay(1000);
