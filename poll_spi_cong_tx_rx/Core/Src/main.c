...
//this function is use loopback->means mosi to miso in master only to be send data
  HAL_SPI_TransmitReceive(&hspi2, tx_buff, rx_buff, sizeof(tx_buff),1000);
  printf("%s\r\n",rx_buff);
